<?php 
    ...
    //Load comment data
    if (isset($_POST["user_id"]) and isset($_POST["component_id"]) and isset($_POST["content"]) and isset($_POST["classroom_id"]) and isset($_POST["role"])) {
        ...
        $insert_content = "INSERT INTO comment(component_id, classroom_id, user_id, content) VALUES ('$component_id','$classroom_id' ,'$user_id', '$content')";
        $conn -> query($insert_content);
